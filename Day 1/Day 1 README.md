...
This is your **Day 1 README.md** file with a structured overview, code examples, and explanations in markdown format. Let me know if you'd like to make any changes! 😊
</span></code></div></div></pre>